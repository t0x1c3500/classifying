        ...
        try:
            async with session.post(
                ...
                if response.status == 200:
                    ...
                    with open(f"./list_13/results/{website}.txt", 'w') as write_s:
...
with open('./list_13/inputs/list_13-input.json', 'r') as read_json:
...
single_prompt = ("Respond with integer only, no text or explanation, Given the list of products sold by an online "
                 "store, rate the likelihood that this store is selling "
