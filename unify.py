...
directory_path = './list_13/products'
all_products_list = {}
...
for filename in os.listdir(directory_path):
    if filename.endswith('.json'):
        ...
        try:
            with open(f"./pipi/list_13/{filename}", 'r') as i_file:
...
with open('./list_13/inputs/list_13-input.json', 'w', encoding="utf-8") as write_json:
